...
<body>
    ...
    <div class="agenda-container">
        ...
        <form id="averia-form">
            ...
            <p>Se envió un correo con la informacíon de la visita </p>
            <p><strong>N° Visita </strong> <span id="visita"></span></p>
            <p><strong>Nombre</strong> <span id="nombre"></span></p>
            <p><strong>Identificación</strong> <span id="cedula"></span></p>
            <p><strong>Teléfono</strong> <span id="telefono"></span></p>
            <p><strong>Fecha-Hora</strong> <span id="fecha-hora"></span></p>
            <p><strong>Dirección</strong> <span id="direccion"></span></p>

            <button onclick="location.href='{{ route('agenda_averias') }}'">Volver al Inicio</button>
