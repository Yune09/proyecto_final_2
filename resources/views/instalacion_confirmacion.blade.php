...
<head>
    ...
    <title>Confirmación de Instalaciones</title>
...
<body>
    ...
    <!-- Contenedor para la Agenda de Instalación -->
    <div class="agenda-container">
        <h1>Confirmación de Instalación</h1>
        <form id="averia-form">
            ...
            <button onclick="location.href='{{ route('instalacion_confirmada') }}'">Confirmar</button>
