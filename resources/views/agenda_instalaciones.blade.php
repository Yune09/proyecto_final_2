...
<body>
        ...
        <ul id="menu-items">
            ...
            <li class="submenu-container">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="{{ route('agenda_averias') }}"><i class="fas fa-calendar-check"></i> Agenda de Avería</a></li>
    ...
    <div class="agenda-container">
        ...
        <div id="instalaciones-table-container"></div>
    </div>

    <script>
        document.getElementById('agenda-form').addEventListener('click', function () {
            const container = document.getElementById('instalaciones-table-container');
    ...
    window.location.href = '/instalacion_confirmacion';
}
